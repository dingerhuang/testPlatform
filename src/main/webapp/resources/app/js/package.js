(function(window){
        ...
        return $('#' + tableId + '').DataTable({
            ...
            ajax:{
                ...
                "data":function(d){
                    ...
                    d.appType=$("#query_appType").val();
                    d.appRelease=$("#query_appRelease").val();
                    d.appEnv=$("#query_appEnv").val();
    ...
    window.page ={
        ...
        }, uploadFileDialog:uploadFileDialog,deletePackage:deletePackage,downloadFile:downloadFile,showImg:showImg,hideImg:hideImg
    }
